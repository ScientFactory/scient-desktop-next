...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.getForkOptions]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.serverSaveCustomModel]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.voiceCorrectTranscript]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.computeCancelManagedRuntime]: AuthOrchestrationOperateScope,
  [WS_METHODS.computeStartSession]: AuthOrchestrationOperateScope,
  [WS_METHODS.computeListSessions]: AuthOrchestrationReadScope,
  [WS_METHODS.computeGetSession]: AuthOrchestrationReadScope,
  [WS_METHODS.computeRestartSession]: AuthOrchestrationOperateScope,
  [WS_METHODS.computeStopSession]: AuthOrchestrationOperateScope,
  [WS_METHODS.computeSubmitExecution]: AuthOrchestrationOperateScope,
  [WS_METHODS.computeCancelExecution]: AuthOrchestrationOperateScope,
  [WS_METHODS.computeInterruptSession]: AuthOrchestrationOperateScope,
  [WS_METHODS.computeListExecutions]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.subscribeDocumentBindingChanges]: AuthOrchestrationReadScope,
